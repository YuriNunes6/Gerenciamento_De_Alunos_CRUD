        ...
        <div class="hidden md:flex md:w-1/2 bg-indigo-600 p-12 flex-col justify-between text-white relative overflow-hidden">
            <div class="relative z-10">
                <div class="flex items-center gap-2 mb-8">
                    ...
                    <span class="text-2xl font-bold tracking-tight">MyStudents</span>
                </div>
            ...
            <div class="relative z-10">
                <p class="text-sm text-indigo-200">© 2026 MyStudents Inc. Todos os direitos reservados.</p>
            </div>
        </div>
